"use strict";
// npm run test challenges-04.test.js
...
const regex = /^[A-Z]/;
const splitRegex = /[\s,).]+/;
const strToArr = str.split(splitRegex);

strToArr.forEach((str)=> {
  if(regex.test(str)) newArr.push(str)
})
return newArr;
...
const findShells = (str) => {
  // Solution code here...
  // const shellsArr = str.split(' ')
  // return shellsArr.filter((shell) => shell.endsWith("ells"));
