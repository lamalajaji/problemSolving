"use strict";
// npm run test challenges-01.test.js
// npm run test code-challenge
/* ------------------------------------------------------------------------------------------------
CHALLENGE 1
...
const addOne = (arr) => {
  // Solution code here...
  let numArr= [];
  arr.forEach(element => numArr.push(element +1));
return numArr
};
...
const addExclamation = (arr) => {
  // Solution code here...
  let localArr = []; 
  arr.forEach((ele) => localArr.push(ele + "!"));
  return localArr
};
...
const allUpperCase = (arr) => {
  // Solution code here...
  let upperCaseArr = [];
  arr.forEach(ele => upperCaseArr.push(ele.toUpperCase()));
  return upperCaseArr
};
...
const speaker = (words, cb) => {
  // Solution code here...
  let newArr = [];
  words.forEach((word)=> newArr.push(cb(word)))
return newArr;
};
...
const createList = (availableItems) => {
  // Solution code here...
  let availables = [];
  availableItems.map((ele)=> {
    if (ele.available === true) availables.push(ele.name)
  })
 return availables
};
