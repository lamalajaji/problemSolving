...
const updateAnimal = (arr, callback) => {
  ...
  let editedArr = [];
  arr.map((ele) => {
    return editedArr.push(callback(ele));
  });
  return editedArr;
};
...
const sortSchedule = (arr) => {
  // Solution code here...
  return arr.sort((a,b)=> {
   const firstMeeting = a.end - a.start;
   const secondMeeting = b.end - b.start;
   return days[a.dayOfWeek] - days[b.dayOfWeek] || firstMeeting - secondMeeting
  })
};
