...
// npm run test challenges-05.test.js
/* ------------------------------------------------------------------------------------------------
CHALLENGE 1 - Review
...
const listFoods = (recipe) => {
  ...
  result = recipe.ingredients.map((ele)=> {
    const space = ele.indexOf(" ");
    const newStr = ele.slice(space + 1);
...
const splitFoods = (recipe) => {
  ...
  // Solution code here...
  result = recipe.ingredients.map((ele)=> {
    const newStr = ele.split(" ");
    return newStr.slice(2).join(' ')
  })
   return result
};
...
const removeVowels = (str) => {
  ...
  // for (let i = 0; i < str.length; i++){
  //   if(str[i] === "o" || str[i] === "u" || str[i] === "i"|| str[i] === "y" || str[i] === "a"){
  //     return str[i]='';
  //   }
  // }
  // return str
